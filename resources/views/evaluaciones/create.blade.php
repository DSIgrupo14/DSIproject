...
<li class="active">
  <a href="{{ route('notas.edit', $gra_mat) }}">{{ $grado->codigo }} - {{ $materia->nombre }}</a>
</li>
<li class="active">Registrar Evaluación</li>
@endsection
...
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title">Registrar Evaluación</h3>
  </div>
  <!-- Formulario -->
  {!! Form::open(['route' => 'evaluaciones.store', 'autocomplete' => 'off', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
    <div class="box-body">
      <!-- Grado -->
