...
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title">Descargar Reportes</h3>
  </div>
 ...
 <div class="container" id="reporte">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p><a class="btn btn-primary btn-flat" href="{{ route('grados.pdf') }}" role="button">Descargar &raquo;</a></p>
        </div>
       
        <div class="col-md-4">
          <h2>Reporte de Docentes</h2>
          <p>Aca encontraras la lista de todos los docentes del Centro Escolar</p>
          <p><a class="btn btn-primary btn-flat" href="{{ route('docentes.pdf') }}" role="button">Descargar &raquo;</a></p>
        </div>
        ...
        <div class="col-md-4">
       <h2>Reporte de Niveles Educativos</h2>
          <p>Aca encuentras toda la lista de los niveles educativos del centro escolar</p>
          <p><a class="btn btn-primary btn-flat" href="{{ route('nivel.pdf') }}" role="button">Descargar &raquo;</a></p>
        </div>
       
        <div class="col-md-4">
          <h2>Reporte de Materias</h2>
          <p>Aca encontraras la lista de todos las materias que imparte del Centro Escolar</p>
          <p><a class="btn btn-primary btn-flat" href="{{ route('materias.pdf') }}" role="button">Descargar &raquo;</a></p>
        </div>
